...
## 2026-07-07 A案 Go/No-Go整理

7月7日 A案「本番決済なし限定公開」の公開前Go/No-Goを整理した。確認者は `KAJISHIFT運用担当`。この記録には、個人名、メールアドレス、住所、電話番号、問い合わせ本文、審査回答本文、問い合わせID、userId風の値、workerId、bookingId、予約ID、submissionId、APIキー、Secret、DB接続文字列、決済情報の実値を記録しない。
