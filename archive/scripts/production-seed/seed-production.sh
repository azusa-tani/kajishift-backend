...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "📋 作成されたテストユーザー:"
    echo "  依頼者1: customer1@example.com / KajiShiftLocalDev!2026"
    echo "  依頼者2: customer2@example.com / KajiShiftLocalDev!2026"
    echo "  ワーカー1: worker1@example.com / KajiShiftLocalDev!2026"
    echo "  ワーカー2: worker2@example.com / KajiShiftLocalDev!2026"
    echo "  ワーカー3: worker3@example.com / KajiShiftLocalDev!2026"
    echo "  管理者: admin@kajishift.com / KajiShiftLocalDev!2026"
    echo ""
    echo "🔍 確認方法:"
